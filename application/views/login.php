...
<div class="row">
	...
	$action = "login/check_user_login";

	echo form_open($action, $attributes);
	?>
		<fieldset>
			<legend><?php echo $this->lang->line("login_form_title"); ?></legend>
			...
			<div class="control-group">
				<label class="control-label" for="user_id"><?php echo $this->lang->line("login_form_login_id"); ?>
					:</label>
				<div class="controls">
					<input type="text" class="input-xlarge" id="user_id" name="user_id"
						placeholder="<?php echo $this->lang->line("login_form_login_id_ph"); ?>" />
					<p class="help-block">
					<?php echo $this->lang->line("example")." ".$this->lang->line("login_form_login_id_eg"); ?>
					</p>
				</div>
			</div>

			<div class="control-group">
				<label class="control-label" for="user_password"><?php echo $this->lang->line("login_form_password"); ?>
					:</label>
				<div class="controls">
					<input type="password" class="input-xlarge" id="user_password"
						name="user_password"
						placeholder="<?php echo $this->lang->line("login_form_password_ph"); ?>" />
				</div>
			</div>

			<div class="form-actions">
				<button class="btn btn-primary" type="submit">
				<?php echo $this->lang->line("login_form_action_btn"); ?>
				</button>
